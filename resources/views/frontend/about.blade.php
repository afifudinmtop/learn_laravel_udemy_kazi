...
<main>
    ...
    <section class="breadcrumb__wrap">
        ...
        <div class="breadcrumb__wrap__icon">
            <ul>
                <li><img src="/frontend/assets/img/icons/breadcrumb_icon01.png" alt=""></li>
                <li><img src="/frontend/assets/img/icons/breadcrumb_icon02.png" alt=""></li>
                <li><img src="/frontend/assets/img/icons/breadcrumb_icon03.png" alt=""></li>
                <li><img src="/frontend/assets/img/icons/breadcrumb_icon04.png" alt=""></li>
                <li><img src="/frontend/assets/img/icons/breadcrumb_icon05.png" alt=""></li>
                <li><img src="/frontend/assets/img/icons/breadcrumb_icon06.png" alt=""></li>
            </ul>
        </div>
    </section>
    <!-- breadcrumb-area-end -->
                    ...
                    <div class="about__info__wrap">
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="about" role="tabpanel" aria-labelledby="about-tab">
                                {!! session('about_long_description') !!}
                            </div>
                                ...
                                <div class="about__award__wrap">
                                    <div class="row justify-content-center">
                                        <div class="col-md-6 col-sm-9">
                                            <div class="about__award__item">
                                                <div class="award__logo">
                                                    <img src="/frontend/assets/img/images/awards_01.png" alt="">
                                                </div>
                                        ...
                                        <div class="col-md-6 col-sm-9">
                                            <div class="about__award__item">
                                                <div class="award__logo">
                                                    <img src="/frontend/assets/img/images/awards_02.png" alt="">
                                                </div>
                                                <div class="award__content">
                                        ...
                                        <div class="col-md-6 col-sm-9">
                                            <div class="about__award__item">
                                                <div class="award__logo">
                                                    <img src="/frontend/assets/img/images/awards_03.png" alt="">
                                                </div>
                                                <div class="award__content">
                                        ...
                                        <div class="col-md-6 col-sm-9">
                                            <div class="about__award__item">
                                                <div class="award__logo">
                                                    <img src="/frontend/assets/img/images/awards_04.png" alt="">
                                                </div>
                                                <div class="award__content">
            ...
            <div class="services__style__two__wrap">
                <div class="row gx-0">
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="services__style__two__item">
                            <div class="services__style__two__icon">
                                <img src="/frontend/assets/img/icons/services_light_icon01.png" alt="">
                            </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="services__style__two__item">
                            <div class="services__style__two__icon">
                                <img src="/frontend/assets/img/icons/services_light_icon02.png" alt="">
                            </div>
                            <div class="services__style__two__content">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="services__style__two__item">
                            <div class="services__style__two__icon">
                                <img src="/frontend/assets/img/icons/services_light_icon03.png" alt="">
                            </div>
                            <div class="services__style__two__content">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="services__style__two__item">
                            <div class="services__style__two__icon">
                                <img src="/frontend/assets/img/icons/services_light_icon05.png" alt="">
                            </div>
                            <div class="services__style__two__content">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="services__style__two__item">
                            <div class="services__style__two__icon">
                                <img src="/frontend/assets/img/icons/services_light_icon06.png" alt="">
                            </div>
                            <div class="services__style__two__content">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="services__style__two__item">
                            <div class="services__style__two__icon">
                                <img src="/frontend/assets/img/icons/services_light_icon04.png" alt="">
                            </div>
                            <div class="services__style__two__content">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="services__style__two__item">
                            <div class="services__style__two__icon">
                                <img src="/frontend/assets/img/icons/services_light_icon07.png" alt="">
                            </div>
                            <div class="services__style__two__content">
                                <h3 class="title"><a href="services-details.html">Visual Design</a></h3>
                                <p>Strategy is a forward-looking plan for your brand’s behavior.Strategy is a forward-looking plan.</p>
    ...
    <section class="testimonial testimonial__style__two">
                                ...
                                <div class="testimonial__content">
                                    ...
                                    <div class="testimonial__avatar">
                                        ...
                                        <div class="testi__avatar__img">
                                            <img src="/frontend/assets/img/images/testi_avatar01.png" alt="">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="testimonial__item">
                                ...
                                <div class="testimonial__content">
                                    ...
                                    <div class="testimonial__avatar">
                                        ...
                                        <div class="testi__avatar__img">
                                            <img src="/frontend/assets/img/images/testi_avatar02.png" alt="">
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="testimonial__two__icons">
            <ul>
                <li><img src="/frontend/assets/img/icons/testi_shape01.png" alt=""></li>
                <li><img src="/frontend/assets/img/icons/testi_shape02.png" alt=""></li>
                <li><img src="/frontend/assets/img/icons/testi_shape03.png" alt=""></li>
                <li><img src="/frontend/assets/img/icons/testi_shape04.png" alt=""></li>
                <li><img src="/frontend/assets/img/icons/testi_shape05.png" alt=""></li>
                <li><img src="/frontend/assets/img/icons/testi_shape06.png" alt=""></li>
            </ul>
        </div>
    </section>
