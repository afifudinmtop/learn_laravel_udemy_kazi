    ...
    <section id="aboutSection" class="about">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="banner__img text-center text-xxl-end">
                        <img src="/storage/about/{{session('about_image')}}" alt="">
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="about__content">
                        <div class="section__title">
                            ...
                            <h2 class="title">{{session('about_title')}}</h2>
                        </div>
                        <div class="about__exp">
                            <div class="about__exp__icon">
                                <img src="/frontend/assets/img/icons/about_icon.png" alt="">
                            </div>
                            <div class="about__exp__content">{{session('about_sub_title')}}</div>
                        </div>
                        <p class="desc">{{session('about_caption')}}</p>
